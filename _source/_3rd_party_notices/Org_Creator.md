---
title: Okta Org Creator product
layout: legal_notice
---
This document contains third party open source licenses and notices for
the Okta Org Creator product. Certain licenses and notices may appear in
...
_Dropwizard_
  ...
  VERSION (IF ANY):    
  -------------------- ------------------------------------------------------------------
  BRIEF DESCRIPTION:   Dropwizard is a sneaky way of making fast Java web applications.
  LICENSE:             Apache 2.0

Dropwizard

Copyright 2010-2013 Coda Hale and Yammer, Inc., 2014-2016 Dropwizard
Team
