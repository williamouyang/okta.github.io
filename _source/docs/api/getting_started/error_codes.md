...
> For example, if the **redirect_uri** is **https://example.com**, then the **UNKNOWN_ENDPOINT** error would be passed as follows:
> 
> ~~~
> https://example.com?error=UNKNOWN_ENDPOINT&error_description=Unknown%20social%20endpoint.
> ~~~
