...
* `/oauth2/:asid/v1/userinfo` for OpenID Connect with API Access Management
...
{% api_operation get /oauth2/:asid/v1/authorize %}
...
~~~sh
how many request examples, which types, should we have?
~~~
...
{% api_operation post /oauth2/:asid/v1/token %}
...
| un#supported_grant_type | The grant_type was not *authorization_code* or *refresh_token*.                                                                                                                                       |
| invalid_scope           | The scopes list contains an invalid or unsupported value.                                                                                                                                             |
...
~~~sh
What request would match the following response?
~~~
...
{% api_operation post /oauth2/:asid/v1/introspect %}
...
The client can authenticate by providing *client_id* and *client_secret* as a part of the URL-encoded form parameters (as described in Request Parameters table above),
...
##### Request Example (Success, Access Token)
{:.api .api-request .api-request-example}
...
##### Request Example (Success, Refresh Token)
{:.api .api-request .api-request-example}
...
##### Request Example (Success, Inactive Token)
{:.api .api-request .api-request-example}
...
{% api_operation post /oauth2/:asid/v1/revoke %}
...
{% api_operation get /oauth2/:asid/v1/keys %}

Retrieve the public keys provided by Okta _________
<!--need to finish this sentence. How are these different from the Auth Server keys other than Okta provides instead of customer? -->
...
{% api_operation get /oauth2/:asid/.well-known/oauth-authorization-server %}
...
~~~json
{
    ...
    "authorization_endpoint": "https://${org}.okta.com/oauth2/{asid}/v1/authorize",
    "token_endpoint": "https://${org}.okta.com/oauth2/{asid}/v1/token",
    "jwks_uri": "https://${org}.okta.com/oauth2/{asid}/v1/keys",
    ...
    "introspection_endpoint": "https://${org}.okta.com/oauth2/{asid}/v1/introspect",
    "introspection_endpoint_auth_methods_supported": [
        "client_secret_basic",
        "client_secret_post",
        "none"
    ],
    "revocation_endpoint": "https://${org}.okta.com/oauth2/{asid}/v1/revoke",
...
#### Retrieve OpenID Connect Metadata for an Authorization Server
{:.api .api-operation}

{% api_operation get /oauth2/:asid/.well-known/openid-configuration %}
...
~~~json
{
    ...
    "authorization_endpoint": "https://${org}.okta.com/oauth2/{asid}/v1/authorize",
    "token_endpoint": "https://${org}.okta.com/oauth2/{asid}/v1/token",
    "userinfo_endpoint": "https://${org}.okta.com/oauth2/{asid}/v1/userinfo",
    "jwks_uri": "https://${org}.okta.com/oauth2/{asid}/v1/keys",
    "response_types_supported": [
        "code",
        "id_token",
...
{% api_operation post /api/v1/authorizationServers %} {% api_lifecycle ea %}
...
~~~json
{
  ...
  "_links": {
    "resources": {
      "href": "${org}/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/resources",
      "hints": {
        "allow": [
          "GET"
        ]
    ...
    "keys": {
      "href": "${org}/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/credentials/keys",
      "hints": {
        "allow": [
          "GET"
        ]
    ...
    "self": {
      "href": "${org}/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3",
      "hints": {
        "allow": [
          "GET",
          "DELETE",
...
}' "https://${org}.okta.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3"
~~~
...
{% api_operation get /api/v1/authorizationServers/:asid %} {% api_lifecycle ea %}

Returns authorization server identified by *asid*.
...
Parameter  | Description                                                                 | Type       | Required       |
---------- | --------------------------------------------------------------------------- | ---------- | ---------------|
asid       | Authorization Server ID. You can find the ID in the Okta user interface.    | String     | True           |
...
~~~json
{
  "id": "aus5m9r1o4AsDJLe50g4",
  "name": "as",
  "description": null,
  "audiences": ["https://httpbin.org"],
  "issuer": "http://{org}.okta.com/oauth2/aus5m9r1o4AsDJLe50g4",
  "status": "ACTIVE",
  "created": "2017-04-04T17:40:52.000Z",
  "lastUpdated": "2017-04-07T05:11:11.000Z",
  "credentials": {
    "signing": {
      "rotationMode": "AUTO",
      "lastRotated": "2017-04-07T05:55:40.000Z",
      "nextRotation": "2017-07-06T05:55:40.000Z",
      "kid": "voSs639Eefk5lKO6EdRgWZcC5fURWneIKyx1fga1G74"
    }
  },
  "_links": {
    "keys": {
      "href": "http://${org}.okta.com/api/v1/authorizationServers/aus5m9r1o4AsDJLe50g4/credentials/keys",
      "hints": {
        "allow": [
          "GET"
        ]
    ...
    "self": {
      "href": "http://${org}.okta.com/api/v1/authorizationServers/aus5m9r1o4AsDJLe50g4",
      "hints": {
        "allow": [
          "GET",
          "PUT"
    ...
    "deactivate": {
      "href": "http://${org}.okta.com/api/v1/authorizationServers/aus5m9r1o4AsDJLe50g4/lifecycle/deactivate",
      "hints": {
        "allow": [
          "POST"
        ]
    ...
    "policies": {
      "href": "http://${org}.okta.com/api/v1/authorizationServers/aus5m9r1o4AsDJLe50g4/policies",
      "hints": {
        "allow": [
          "GET",
          "POST"
    ...
    "claims": {
      "href": "http://${org}.okta.com/api/v1/authorizationServers/aus5m9r1o4AsDJLe50g4/claims",
      "hints": {
        "allow": [
          "GET",
          "POST"
    ...
    "scopes": {
      "href": "http://${org}.okta.comcrednentials/keys/api/v1/authorizationServers/aus5m9r1o4AsDJLe50g4/scopes",
      "hints": {
        "allow": [
          "GET",
          "POST"
...
{% api_operation get /api/v1/authorizationServers/:asid/policies %}
...
{% api_operation put /api/v1/authorizationServers/:asid/policies/:pid %}
...
{% api_operation DELETE /api/v1/authorizationServers/:asid/policies/00p5m9xrrBffPd9ah0g4 %}
...
{% api_operation get /api/v1/authorizationServers/:asid/credentials/keys %} {% api_lifecycle beta %}
  ...
  "keys": [
             {
               ...
               "_links": {
                 "self": {
                   "href": "http://${org}.okta.com/api/v1/authorizationServers/aus5m9r1o4AsDJLe50g4/credentials/keys/RQ8DuhdxCczyMvy7GNJb4Ka3lQ99vrSo3oFBUiZjzzc",
                   "hints": {
                     "allow": [
                       "GET"
                     ]
    ...
    },
    {
      ...
      "kid": "Y3vBOdYT-l-I0j-gRQ26XjutSX00TeWiSguuDhW3ngo",
      "kty": "RSA",
      "use": "sig" <!--need "_links" when status is NEXT -->
    },
    {
      "status": "EXPIRED",
      "alg": "RS256",
      ...
      "kid": "h5Sr3LXcpQiQlAUVPdhrdLFoIvkhRTAVs_h39bQnxlU",
      "kty": "RSA",
      "use": "sig" <!--need "_links" when status is EXPIRED -->
    }
  ]
}
~~~
...
{% api_operation post /api/v1/authorizationServers/:asid/credentials/lifecycle/keyRotate %} {% api_lifecycle beta %}
