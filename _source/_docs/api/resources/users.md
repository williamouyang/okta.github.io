...
Okta does not support uploading images via the Users API.  As such, all operations in this API that update properties work in a slightly different way when applied to image properties:
